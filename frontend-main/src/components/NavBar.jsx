...
import { PlusSmIcon, CalendarIcon } from '@heroicons/react/solid';
						...
						<div className='flex justify-between h-16'>
							<div className='flex'>
								...
								<div className='flex-shrink-0 flex items-center'>
									<CalendarIcon className='block text-blue-600 lg:hidden h-8 w-auto' />
									<Link to='/'>
										<div className='hidden lg:flex lg:items-center lg:space-x-2'>
											<CalendarIcon className='h-6 w-auto text-blue-600' />
											<h1 className='font-bold mt-0.5'>Holiday Requests</h1>
										</div>
									</Link>
								</div>
									...
									<NavLink
										...
										className={(n) =>
											n.isActive
												...
												: 'border-transparent hover:border-gray-300 hover:text-gray-700 text-gray-500 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium'
										}>
										Dashboard
									</NavLink>
									<NavLink
						...
						<div className='pt-2 pb-3 space-y-1'>
							...
							<Disclosure.Button as='div'>
								<NavLink
									...
									className={(n) =>
										n.isActive
											? 'bg-blue-50 border-blue-500 text-blue-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium sm:pl-5 sm:pr-6'
